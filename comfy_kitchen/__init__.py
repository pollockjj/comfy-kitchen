...
def restore_weighted_reduce_int8_moe_routes(
    ...
    """Restore, weight, and reduce expert-sorted INT8 MoE rows."""
    return _cuda_backend.restore_weighted_reduce_int8_moe_routes(
        routed_output, route_dest, route_weights, top_k
    )
