...
using PackedInt8GateM128Kernel = typename cutlass::gemm::kernel::DefaultGemmGrouped<
    int8_t,
    cutlass::layout::RowMajor,
    cutlass::ComplexTransform::kNone,
    16,
    ...
    cutlass::gemm::kernel::GroupScheduleMode::kDeviceOnly,
    cutlass::arch::OpMultiplyAddSaturate>::GemmKernel;
using PackedInt8GateM128Gemm = cutlass::gemm::device::GemmGrouped<PackedInt8GateM128Kernel>;
...
bool run_packed_grouped_int8(
    ...
    if (gate_up_shape) {
        typename PackedInt8GateM128Gemm::EpilogueOutputOp::Params epilogue(1, 0);
        typename PackedInt8GateM128Gemm::Arguments arguments(
            problem_sizes,
            groups,
            threadblock_count,
            epilogue,
